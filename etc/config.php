...
return [
    'modules' => [
        ...
        'Bss_PromotionBar' => 1,
        'Bss_SalesRep' => 0,
        'Bss_ReorderProduct' => 0,
        'Bss_RewardPoint' => 1,
        'Bss_RewardPointGraphQl' => 1,
        'Bss_CompanyAccount' => 1,
        'Bss_StoreCredit' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Ecomwise_ForcedLogin' => 1,
        'Ecomwise_Overrides' => 1,
        'Klarna_Core' => 1,
        ...
        'Magebees_Attribute' => 0,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Punchout2go_Punchout' => 1,
        'Temando_ShippingRemover' => 1,
        'Vertex_Tax' => 1,
        'Vertex_AddressValidationApi' => 1,
        'Vertex_AddressValidation' => 1,
        'Wise_GroupedCatalog' => 1,
        'Wise_PriceCalculation' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
