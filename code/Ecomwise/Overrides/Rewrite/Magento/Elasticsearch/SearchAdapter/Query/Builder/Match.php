...
namespace Ecomwise\Overrides\Rewrite\Magento\Elasticsearch\SearchAdapter\Query\Builder;
...
class Match extends \Magento\Elasticsearch\SearchAdapter\Query\Builder\Match
{
 ...
 /**
    ...
    public function build(array $selectQuery, RequestQueryInterface $requestQuery, $conditionType)
    {
        ...
        echo "<pre> elasticsearch select query <pre>";
        echo microtime (true);
        echo "pre";
        echo json_encode($selectQuery, JSON_PRETTY_PRINT);
        die;
