...
class Save extends \Bss\CustomerAttributes\Controller\Adminhtml\Attribute\Save
{
    ...
    protected function getUsedInForm($data)
    {
        ...
        $usedInForms[0] = 'adminhtml_customer_address';
        $usedInForms[1] = 'adminhtml_customer';
        $usedInForms[2] = 'customer_register_address';
        $usedInForms[3] = 'customer_address';
        $usedInForms[4] = 'is_customer_attribute';
        $num = 5;
    ...
    {
        if (isset($data['adminhtml_checkout']) && $data['adminhtml_checkout'] == 1) {
            $usedInForms[$num] = 'adminhtml_checkout';
