 ...
 * Class Bar
 *
 * @package Bss\PromotionBar\Block\Adminhtml\Bar\Edit\Tab
 */
class Bar extends \Magento\Backend\Block\Widget\Form\Generic implements TabInterface
{
    /**
     *  System Store
     *
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note' => $this->
                escapeHtml(__('Please enter in yyyy-mm-dd hh:mm:ss or yyyy-mm-dd format. Example: 2019-01-23 00:00:00 or 2019-01-23'))
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'time_format' => 'HH:mm:ss',
                'note' => $this->
                escapeHtml(__('Please enter in yyyy-mm-dd hh:mm:ss or yyyy-mm-dd format. Example: 2019-01-31 00:00:00 or 2019-01-31'))
            ]
        );
