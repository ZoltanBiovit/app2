...
class ModuleConfig extends AbstractHelper
{
    ...
    {
        $enableProductRestricted = $this->enableProductRestricted($storeId);
        $configUseParentCategory = $this->scopeConfig->getValue(
            'catalog_permission/general/use_parent_category',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
        return $enableProductRestricted && $configUseParentCategory;
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'catalog_permission/cms_general/url_link',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'catalog_permission/general/url_link',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
